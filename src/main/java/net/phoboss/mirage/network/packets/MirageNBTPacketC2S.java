                    ...
                    */
                    ...
                    Mirage.SERVER_THREAD_POOL.submit(() -> {
                        try{
                            ...
                            player.displayClientMessage(Component.literal("loading: "+fileName+" totalFragments:"+totalFragments), false);
                        }catch (Exception e){
                    ...
                    player.displayClientMessage(Component.literal("Could not load NBT file: "+fileName), false);
                }

                //player.displayClientMessage(Component.literal("THIS MESSAGE IS FROM THE SERVER"), false);
